  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const reserved = stallsData.filter((s) => s.Confirmed === true).length;
      ...
      try {
        const reservationsRes = await httpRequest({
          ...
          <div className="stall-map-container">
            <div className="stall-map-header">
              ...
              <div className="filter-buttons">
                <button
                  className={
                    sizeFilter === "all" ? "filter-btn active" : "filter-btn"
                  }
